...
export default function ProAnimatedEngagementPage({ onImageLoad, introFinished }: ProAnimatedEngagementPageProps) {
  ...
  const eventDate = new Date("2026-08-20T20:00:00");
    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-secondary/20 overflow-x-hidden pt-0">
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <div>
            <CountdownTimer targetDate={new Date("2026-08-20T20:00:00")} />
          </div>
        </div>
      </section>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="relative z-10 text-center">
                ...
                {/* Venue Name */}
                <motion.h3
                  className="font-elegant text-2xl md:text-3xl lg:text-4xl text-foreground mb-2 tracking-wide"
