...
export const translations: Translations = {
  ...
  footerMessage: {
    en: "Ready for the unforgettable night?🥺",
    ar: 'مستعدين لليلة لا تُنسى؟🥺'
  },
  sendingMessage: {
  ...
  brideGroomNote: {
    en: 'Bride: Ikhlas & Groom: Hamad',
    ar: 'العروس: إخلاص والعريس: حمد',
  },
  giftNote: {
    en: 'Your presence is the only gift we truly desire! Thank you for celebrating this special day with us❤️',
    ar: 'حضوركم هو الهدية الوحيدة التي نتمناها! شكراً لاحتفالكم معنا في هذا اليوم المميز❤️',
  },
};
